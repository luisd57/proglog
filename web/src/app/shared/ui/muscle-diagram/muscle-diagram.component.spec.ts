...
import { MuscleDiagramComponent } from './muscle-diagram.component';

describe('MuscleDiagramComponent', () => {
  function render(highlights: Record<string, string>) {
    const fixture = TestBed.createComponent(MuscleDiagramComponent);
